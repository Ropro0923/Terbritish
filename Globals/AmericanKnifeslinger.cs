...
namespace Terbritish.Globals
{
    ...
    public class DrivingInMyCar : GlobalItem
    {
        ...
        public override bool AppliesToEntity(Item item, bool lateInstantiation)
        {
            if (ModLoader.TryGetMod("gunrightsmod", out Mod TerMerica) && TerMerica.TryFind<ModItem>("VerdantClaymore", out ModItem VerdantClaymore))
            {
    ...
    public class RightAfterABeer : GlobalItem
    {
        ...
        public override bool AppliesToEntity(Item item, bool lateInstantiation)
        {
            if (ModLoader.TryGetMod("gunrightsmod", out Mod TerMerica) && TerMerica.TryFind<ModItem>("SaberOfTheEuropoor", out ModItem SaberOfTheEuropoor))
            {
