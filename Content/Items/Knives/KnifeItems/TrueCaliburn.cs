...
namespace Terbritish.Content.Items.Knives.KnifeItems
{
    public class TrueCaliburn : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TrueCaliburnStab>();
        ...
        {
            if (type == ModContent.ProjectileType<TrueCaliburnStab>())
            {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                Projectile.NewProjectile(source, position, velocity* 2.7f, ModContent.ProjectileType<TrueCaliburnThrown>(), (int)(damage * 0.67f), knockback, player.whoAmI);
                return false;
            }
            return true;
        }
