...
namespace Terbritish.Content.Items.Knives.KnifeItems
{
    public class TungstenKnife : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<TungstenKnifeStab>();
        ...
        {
            if (type == ModContent.ProjectileType<TungstenKnifeStab>())
            {
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                int proj = Projectile.NewProjectile(source, position, velocity * 2.67f, ModContent.ProjectileType<TungstenKnifeThrown>(), (int)(damage * 0.67f), (int)(knockback * 0.99f), player.whoAmI);
