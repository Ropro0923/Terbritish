...
namespace Terbritish.Content.Projectiles
{
	...
	public class BiscuitBeaterProjectile : ModProjectile
	{
		private const string ChainTexturePath = "Terbritish/Content/Projectiles/BiscuitBeaterProjectileChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Terbritish/Content/Projectiles/BiscuitBeaterProjectileChainExtra";  // This texture and related code is optional and used for a unique effect
